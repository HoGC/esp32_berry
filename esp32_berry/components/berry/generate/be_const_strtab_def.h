...
be_define_const_str(_X2B, "+", 772578730u, 0, 1, &be_const_str_isnan);
be_define_const_str(_X2E_X2E, "..", 2748622605u, 0, 2, &be_const_str_keys);
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str_mkdir);
...
be_define_const_str(_buffer, "_buffer", 2044888568u, 0, 7, &be_const_str_contains);
...
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_byte);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_count);
be_define_const_str(as, "as", 1579491469u, 67, 2, NULL);
be_define_const_str(asin, "asin", 4272848550u, 0, 4, &be_const_str_item);
be_define_const_str(assert, "assert", 2774883451u, 0, 6, &be_const_str_input);
...
be_define_const_str(bool, "bool", 3365180733u, 0, 4, &be_const_str_concat);
...
be_define_const_str(char, "char", 2823553821u, 0, 4, &be_const_str_clock);
be_define_const_str(chdir, "chdir", 806634853u, 0, 5, &be_const_str_tostring);
be_define_const_str(class, "class", 2872970239u, 57, 5, &be_const_str_return);
be_define_const_str(classname, "classname", 1998589948u, 0, 9, NULL);
be_define_const_str(classof, "classof", 1796577762u, 0, 7, &be_const_str_clear);
...
be_define_const_str(concat, "concat", 4124019837u, 0, 6, &be_const_str_exists);
...
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_exp);
be_define_const_str(do, "do", 1646057492u, 65, 2, &be_const_str_import);
...
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_if);
be_define_const_str(except, "except", 950914032u, 69, 6, NULL);
be_define_const_str(exists, "exists", 1002329533u, 0, 6, &be_const_str_remove);
be_define_const_str(exit, "exit", 3454868101u, 0, 4, &be_const_str_reverse);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_insert);
be_define_const_str(false, "false", 184981848u, 62, 5, NULL);
be_define_const_str(find, "find", 3186656602u, 0, 4, &be_const_str_geti);
be_define_const_str(floor, "floor", 3102149661u, 0, 5, &be_const_str_module);
be_define_const_str(for, "for", 2901640080u, 54, 3, NULL);
be_define_const_str(format, "format", 3114108242u, 0, 6, &be_const_str_imax);
be_define_const_str(fromb64, "fromb64", 2717019639u, 0, 7, NULL);
be_define_const_str(fromhex, "fromhex", 1847150394u, 0, 7, &be_const_str_lower);
...
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, &be_const_str_getfloat);
be_define_const_str(getcwd, "getcwd", 652026575u, 0, 6, &be_const_str_solidified);
be_define_const_str(getfloat, "getfloat", 2820979603u, 0, 8, &be_const_str_isfile);
...
be_define_const_str(imin, "imin", 2714127864u, 0, 4, &be_const_str_break);
be_define_const_str(import, "import", 288002260u, 66, 6, NULL);
be_define_const_str(init, "init", 380752755u, 0, 4, NULL);
be_define_const_str(input, "input", 4191711099u, 0, 5, &be_const_str_static);
be_define_const_str(insert, "insert", 3332609576u, 0, 6, &be_const_str_rad);
be_define_const_str(int, "int", 2515107422u, 0, 3, &be_const_str_seti);
be_define_const_str(isdir, "isdir", 2340917412u, 0, 5, &be_const_str_setitem);
...
be_define_const_str(issubclass, "issubclass", 4078395519u, 0, 10, &be_const_str_sinh);
be_define_const_str(item, "item", 2671260646u, 0, 4, NULL);
be_define_const_str(iter, "iter", 3124256359u, 0, 4, &be_const_str_setbits);
be_define_const_str(join, "join", 3374496889u, 0, 4, NULL);
be_define_const_str(keys, "keys", 4182378701u, 0, 4, &be_const_str_sin);
be_define_const_str(length_X20in_X20bits_X20must_X20be_X20between_X200_X20and_X2032, "length in bits must be between 0 and 32", 2584509128u, 0, 39, &be_const_str_print);
...
be_define_const_str(map, "map", 3751997361u, 0, 3, &be_const_str_tohex);
be_define_const_str(mkdir, "mkdir", 2883839448u, 0, 5, &be_const_str_setrange);
be_define_const_str(module, "module", 3617558685u, 0, 6, &be_const_str_push);
...
be_define_const_str(push, "push", 2272264157u, 0, 4, &be_const_str_real);
be_define_const_str(rad, "rad", 1358899048u, 0, 3, &be_const_str_tob64);
...
be_define_const_str(set, "set", 3324446467u, 0, 3, &be_const_str_tr);
...
be_define_const_str(setitem, "setitem", 1554834596u, 0, 7, &be_const_str_time);
be_define_const_str(setrange, "setrange", 3794019032u, 0, 8, &be_const_str_tan);
be_define_const_str(sin, "sin", 3761252941u, 0, 3, &be_const_str_type);
...
be_define_const_str(super, "super", 4152230356u, 0, 5, &be_const_str_do);
be_define_const_str(system, "system", 1226705564u, 0, 6, NULL);
be_define_const_str(tan, "tan", 2633446552u, 0, 3, &be_const_str_toupper);
...
be_define_const_str(tostring, "tostring", 2299708645u, 0, 8, &be_const_str_true);
be_define_const_str(toupper, "toupper", 3691983576u, 0, 7, &be_const_str_false);
be_define_const_str(tr, "tr", 1195724803u, 0, 2, &be_const_str_elif);
